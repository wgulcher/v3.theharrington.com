    ...
    <div class="row">
        ...
        <div class="col-md-6 col-lg-7">
            ...
            <div class="block">
                ...
                <!-- Update Status Form -->
                <form action="page_forms_components.php" method="post" class="block-content-full block-content-mini-padding" onsubmit="return false;">
                ...
                <div class="gallery" data-toggle="lightbox-gallery">
                    <div class="row">
                        <div class="col-xs-6 col-sm-3">
                            <a href="img/placeholders/photos/phot12.jpg" class="gallery-link" title="Image Info">
