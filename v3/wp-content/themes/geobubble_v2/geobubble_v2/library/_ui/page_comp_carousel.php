...
<div id="page-content">
    ...
    <div class="content-header">
        <div class="header-section">
            <h1>
                <i class="gi gi-picture"></i>Carousel<br><small>Easy to setup with lots of options!</small>
            </h1>
        </div>
    </div>
    ...
    <div class="row">
        ...
        <div class="col-sm-4">
            ...
            <div class="block">
                ...
                <div class="block-title">
                    <h2><strong>Animation</strong> only</h2>
                </div>
    ...
    <div class="block">
        ...
        <div class="block-title">
            <h2><strong>Gallery</strong> Carousel</h2>
        </div>
