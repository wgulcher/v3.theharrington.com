        ...
        <div class="col-md-6">
            ...
            <div class="block">
                ...
                <form action="page_forms_components.php" method="post" class="form-horizontal form-bordered" onsubmit="return false;">
                    ...
                    <fieldset>
                        <legend><i class="fa fa-angle-right"></i> Advanced Select Boxes</legend>
                        <div class="form-group">
        ...
        <div class="col-md-6">
            ...
            <div class="block hidden-lt-ie9">
                ...
                <div class="block-title">
                    ...
                    <h2><strong>Switches</strong> <small>(> IE8)</small></h2>
                </div>
                <!-- END Switches Title -->
            ...
            <div class="block">
                ...
                <form action="page_forms_components.php" method="post" class="form-horizontal form-bordered" onsubmit="return false;">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            <input type="text" id="example-slider-range1" name="example-slider-range1" class="form-control input-slider" data-slider-min="0" data-slider-max="1000" data-slider-step="1" data-slider-value="[400,600]" data-slider-orientation="horizontal" data-slider-tooltip="show">
            ...
            <div class="block">
                ...
                <div class="block-title">
                    ...
                    <h2><strong>Simple</strong> Editor</h2>
                </div>
                ...
                <form action="page_forms_components.php" method="post" class="form-horizontal form-bordered" onsubmit="return false;">
                    ...
                    <div class="form-group">
                        <div class="col-xs-12">
                            <textarea id="textarea-wysiwyg" name="textarea-wysiwyg" rows="5" class="form-control textarea-editor"></textarea>
                        </div>
                    </div>
                    <div class="form-group form-actions">
                        <div class="col-xs-12">
