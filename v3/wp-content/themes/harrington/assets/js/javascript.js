	...
	/*var container = document.querySelector('#container');
	  ...
	  itemSelector: '.item'
			...
			$('form').on('submit',function() {
				...
				var link = "http://www.theharrington.com/v3/availability/?loadOBMApplication.action?siteId=FINEXHARR3&request_locale=en&chainAction=newAvailabilitySearch&arrival="+day+"%2F"+month+"%2F"+year+"&numberOfPersons="
						+numberOfGuests+
