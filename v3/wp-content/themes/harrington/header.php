...
<!--[if (gte IE 9)|(gt IEMobile 7)|!(IEMobile)|!(IE)]><!--><html <?php language_attributes(); ?> class="no-js"><!--<![endif]-->
	...
	<head>
	<link rel="icon" href="http://www.theharrington.com/v3/wp-content/themes/harrington/assets/img/favico.ico" />
		 <script src="https://ajax.googleapis.com/ajax/libs/jquery/1.9.0/jquery.min.js"></script> 
		<script src="//ajax.googleapis.com/ajax/libs/jqueryui/1.10.3/jquery-ui.min.js"></script>

		<script type="text/javascript" src="http://www.theharrington.com/v3/wp-content/themes/harrington/assets/js/header.js">
		<!-- header js-->
		</script>
